...
const experiences = [
  {
    ...
    skills: ["API Development", "Trading Strategy Automation", "Cryptocurrency Exchange Integration", "TradingView Integration", "Risk Management", "Webhook Implementation"],
  },
  {
    title: "Web Developer",
    company: "Al Nasr",
    ...
    skills: ["Frontend Development", "Responsive Design", "API Integration", "Google Maps Integration", "UI Implementation", "Cross-browser Compatibility"],
  },
  {
    title: "Web Developer",
    company: "Joseph",
    ...
    skills: ["UI/UX Design", "Portfolio Development", "Social Media Integration", "Client Communication", "Server Deployment", "Responsive Web Design"],
  },
  {
    ...
    skills: ["Backend Architecture", "AI Integration", "Process Automation", "API Development", "Database Design", "System Architecture", "File Management", "Data Handling"],
  },
  {
    ...
    skills: ["Web Scraping", "Data Extraction", "Process Automation", "Cross-functional Collaboration", "Technical Documentation", "Scalable Solution Design"],
  },
  {
    ...
    skills: ["Machine Learning", "Computer Vision", "AI Model Training", "Dataset Collection", "Real-time Processing", "Emergency Vehicle Detection"],
  },
  {
    ...
    tech: ["C++", "Arduino IDE"],
    skills: ["IoT Development", "Sensor Integration", "Hardware Programming", "Automation", "Circuit Design", "Embedded Systems"],
  },
  {
    ...
    tech: ["C++", "Unity"],
    skills: ["Game Development", "Character Design", "Level Design", "Game Mechanics", "User Experience Design", "3D Modeling"],
  },
  {
    ...
    skills: ["Blockchain Development", "Smart Contract Development", "Transaction Security", "Decentralized Systems", "Cryptographic Implementation"],
  },
  {
    ...
    skills: ["Software Architecture", "System Design", "Full-stack Development", "Backend Development", "Frontend Development", "Architecture Patterns"],
  },
  {
    title: "C++ Developer",
    ...
    skills: ["Object-Oriented Programming", "Backend Development", "System Design", "Dependency Management", "Database Design", "Algorithm Optimization"],
  },
];
                  ...
                  >
                    ...
                    >
                      {exp.skills.map((skill) => (
                        <span
                          key={skill}
                          className="px-2.5 py-0.5 text-[10px] font-medium bg-accent/10 text-accent rounded-full border border-accent/20"
                        >
                          {skill}
                        </span>
                      ))}
